...
#define DEFAULT_STEER_COEFFICIENT   3276  // Defualt for STEER_COEFFICIENT 0.5f [-] higher value == stronger. [0, 65535] = [-2.0 - 2.0]. In this case  8192 = 0.5 * 2^14. If you do not want any steering, set it to 0.
...
// ############################### DEBUG LCD ###############################
  #define DEBUG_I2C_LCD                // standard 16x2 or larger text-lcd via i2c-converter on right sensor board cable
    #define OLED_DISPLAY                //uncomment for ssd1306 oled support to replace lcd, config in ssd1306_conf.h
// ########################### END OF DEBUG LCD ############################
