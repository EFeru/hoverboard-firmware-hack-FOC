...
*/
  // #define DUAL_INPUTS                     // ADC*(Primary) + PWM(Auxiliary). Uncomment this to use Dual-inputs
    ...
    #define PRI_INPUT1            3, -1000, 0, 2000, 150  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    #define PRI_INPUT2            3, -1000, 0, 2000, 150  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #endif
