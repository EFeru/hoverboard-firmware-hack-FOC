 ...
 * 2 - Board with CPU 32F303RCT6. See foto board-2 in docs folder.
 * 3 - Board like NineBot. See foto board-3 in docs folder.
*/
#define BOARD_VARIANT           0         // [0..3] change if board with alternate pin mapping
