...
*/
    ...
    #define PRI_INPUT1            2,  1000, 0, 2000, 0  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    #define PRI_INPUT2            2,  1000, 0, 2000, 0  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #endif
