...
#define CTRL_MOD_REQ    TRQ_MODE        // [-] Control mode request: , VLT_MODE (default), SPD_MODE, TRQ_MODE. Note: SPD_MODE and TRQ_MODE are only available for CTRL_FOC!
...
*/
  ...
  #define PRI_INPUT2            3, 0, 0, 4095, 0      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    ...
    #define AUX_INPUT1          3, 0, 0, 3900, 100  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    #define AUX_INPUT2          3, 0, 0, 3900, 100  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #else
...
// ############################ VARIANT_HOVERCAR SETTINGS ############################
  ...
  #define PRI_INPUT1              1,  0, 0, 3900, 100  // Pedal Brake        TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2              1,  500, 0, 3900, 100  // Pedal Accel        TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
